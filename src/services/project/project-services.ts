...
// Удаления проекта
export const removeProjectFromServer = async (
  userId: string,
  projectID: string,
  projects: Array<IProject>
) => {
...
export const addTodoToProject = async (
  userId: string,
  projectId: string,
  projects: Array<IProject>,
  newProject: IProjectTodo
) => {
  let newArray: Array<IProject> = projects.map((project) => {
    if (project.id === projectId) {
      return {
        ...project,
        todos: [...project.todos, { ...newProject }],
...
export const toggleTodoToProject = async (
  userId: string,
  projectId: string,
  projects: Array<IProject>,
  todoId: string
...
export const removeTodoToProject = async (
  userId: string,
  projectId: string,
  projects: Array<IProject>,
  todoId: string
